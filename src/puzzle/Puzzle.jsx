...
export const Puzzle = ({ setGameState }) => {
  const piecesRandomizer = (pieces) => {
    ...
    console.log("pieces copy", piecesCopy);
  ...
  const [pieces, setPieces] = useState(
    piecesRandomizer([
      { id: 1, image: "../assets/piece-1.jpg" },
      { id: 2, image: "../assets/piece-2.jpg" },
      { id: 3, image: "../assets/piece-3.jpg" },
      { id: 4, image: "../assets/piece-4.jpg" },
    ])
  );
